...
chapter4baa = print("""
    ...
    Your decision to persist in studying the forbidden scrolls has led to a significant advancement in your cosmic ninja abilities. As you delve deeper into their teachings, you uncover ancient techniques that grant you extraordinary powers. Your skills become unparalleled, and you become a legend within the academy, with some whispering that you might be the most powerful cosmic ninja in generations.
    However, your mastery of the forbidden techniques does not go unnoticed. Rumors about your extraordinary abilities reach the ears of Master Shinobi and the academy authorities. They call you in for a private meeting to address your actions.
    Inside Master Shinobi's office, you face the consequences of your choices. He acknowledges your remarkable progress but expresses concern about the potential dangers of wielding such power.""")

chapter4bab = print("""
    Chapter 4: A Noble Decision
    Your sense of responsibility prevails, and you make the difficult but principled choice to halt your exploration of the forbidden scrolls. With caution and determination, you carefully return the scrolls to their hiding place, ensuring that they remain safely locked away.
    Word of your noble decision reaches the academy instructors and mentors, earning you their respect and trust. They acknowledge the wisdom in your actions, understanding the potential dangers that could have arisen from the use of the forbidden techniques.
    In recognition of your integrity and dedication to the academy's values, Master Shinobi himself requests a meeting with you to discuss your future within the cosmic ninja order.
    """)

chapter4bba = print("""
    Chapter 4: The Final Act
    Your unwavering commitment to the principles of the academy and your belief that the forbidden scrolls pose a significant risk to the cosmic ninja world lead you to fully support the academy's decision to destroy them. You join the academy authorities and a team of trusted cosmic ninjas as they prepare for the final act.
    The night chosen for the scrolls' destruction is marked with solemnity. In a secured chamber deep within the academy, the scrolls are placed on a pedestal, surrounded by protective wards and barriers. The most skilled cosmic ninjas assemble to ensure the scrolls' complete eradication.
    As the moment arrives to initiate the destruction, a powerful surge of energy emanates from the scrolls, pushing back those in attendance. The forbidden knowledge within the scrolls fights against its own demise, attempting to resist the obliteration.""")

chapter4bbb = print("""
    Chapter 4: The Scholar's Gambit
    Your unwavering belief that the forbidden scrolls hold potential for the greater good leads you to passionately advocate for their preservation and further study. You present a compelling argument before the academy council, emphasizing the importance of responsible exploration of the ancient techniques.
    The council members, including Master Shinobi, listen intently as you lay out your case. The discussions are heated, with differing viewpoints on the scrolls' potential benefits and risks. Ultimately, a decision is reached to allow controlled and monitored research into the forbidden knowledge.
    You are entrusted with a significant role in this endeavor, working closely with other skilled cosmic ninjas and scholars to unlock the secrets of the scrolls while ensuring they do not fall into the wrong hands.""")
...
chapter4baa_option_a = print("""
    OPTION A
    You choose to continue down the path of mastering the forbidden techniques, believing that your unparalleled skill can protect the galaxy from cosmic threats.""")
chapter4baa_option_b = print("""
    OPTION B
    In response to Master Shinobi's concerns, you request his guidance on how to use your newfound powers for the greater good and to uphold the values of the cosmic ninja order.""")

chapter4bab_option_a = print("""
    OPTION A
    During the meeting with Master Shinobi, you express your desire to continue your training within the academy, emphasizing your commitment to upholding its principles and values.""")
chapter4bab_option_b = print("""
    OPTION B
    You propose a plan to help safeguard the forbidden scrolls, ensuring that they remain inaccessible to anyone who might seek their power for nefarious purposes.""")

chapter4bba_option_a = print("""
    OPTION A
    You steadfastly stand your ground, determined to see the destruction through to the end, regardless of the challenges it presents.""")
