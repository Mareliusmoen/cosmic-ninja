...
pose to the galaxy. They invite you to present your findings and insights, along
with Hiro, who supports your decision. Inside the council chamber, the air is 
charged with anticipation. The council members, including Master Shinobi,listen
carefully as you share your knowledge and concerns regarding the Starshard.""")
...
Your sense of responsibility prevails, and you make the difficult but principled
choice to halt your exploration of the forbidden scrolls. With caution and 
determination, you carefully return the scrolls to their hiding place, ensuring
that they remain safely locked away. Word of your noble decision reaches the 
academy instructors and mentors, earning you their respect and trust. They 
...
Your unwavering commitment to the principles of the academy and your belief that
the forbidden scrolls pose a significant risk to the cosmic ninja world lead you
to fully support the academy's decision to destroy them. You join the academy 
authorities and a team of trusted cosmic ninjas as they prepare for the final 
act. The night chosen for the scrolls' destruction is marked with solemnity. 
In a secured chamber deep within the academy, the scrolls are placed on a 
pedestal, surrounded by protective wards and barriers. The most skilled cosmic 
ninjas assemble to ensure the scrolls' complete eradication.As the moment 
arrives to initiate the destruction, a powerful surge of energy emanates from 
the scrolls, pushing back those in attendance. The forbidden knowledge within 
the scrolls fights against its own demise, attempting to resist the obliteration""")
...
Your unwavering belief that the forbidden scrolls hold potential for the greater
good leads you to 
passionately advocate for their preservation and further study. You present a 
compelling argument before the academy council, emphasizing the importance of 
responsible exploration of the ancient techniques. The council members, 
including Master Shinobi, listen intently as you lay out your case. 
The discussions are heated, with differing viewpoints on the scrolls' potential
benefits and risks. Ultimately, a decision is reached to allow controlled and 
monitored research into the forbidden knowledge.You are entrusted with a 
significant role in this endeavor, working closely with other skilled cosmic 
ninjas and scholars to unlock the secrets of the scrolls while ensuring they 
...
Starshard, you choose to delay your entry into the temple and consider your next
steps carefully.""")
...
def chapter4bbb_option_a():
    print("""
    OPTION A
You fully commit to the research of the forbidden scrolls, determined to harness
their power responsibly and for the greater good of the cosmic ninja world.""")
