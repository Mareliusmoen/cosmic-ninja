"""
    This file containes the functions that print chapter 2 and its connected
    options to terminal.

    These functions prints the multiline text string representing
    the chapter 2 that is chosen based on your previous descicions,
    and that chapter 2s connected options.
...
sparring matches and seek to learn from each encounter. This choice will lead
to further interactions with Hiro, where you'll uncover more about his
...
def chapter2b_option_a():
    ...
    print("""
    OPTION A
You decide to study the forbidden scrolls in secret, curious about the
knowledge they hold.""")
